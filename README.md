...
It analyzes player performance statistics (batting, bowling, and all-round skills), reduces feature complexity using PCA, and recommends:
- The best performing fantasy team based on user preferences.
- Similar players using PCA feature space and Euclidean distance
